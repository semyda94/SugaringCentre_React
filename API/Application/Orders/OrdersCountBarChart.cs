...
{
    public class OrdersCountBarChart
    {
        ...
        public class Handler: IRequestHandler<Query, ChartData> {
            ...
            public async Task<ChartData> Handle(Query request, CancellationToken cancellationToken)
            {
                ...
                for (int i = 0; i < 6; ++i) {
                    ...
                    dataset.Data.Add(_context.Orders.Count(o => o.Date.Year == dateFrom.AddMonths(i).Year && o.Date.Month == dateFrom.AddMonths(i).Month));
                }
